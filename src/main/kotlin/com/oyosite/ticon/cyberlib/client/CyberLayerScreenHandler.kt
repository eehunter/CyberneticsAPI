...
class CyberLayerScreenHandler(syncId: Int, inv: PlayerInventory, buf: PacketByteBuf) : ScreenHandler(CYBER_LAYER_SCREEN_HANDLER, syncId) {
    val power = PowerHolderComponent.KEY.get(inv.player).getPower(PowerTypeRegistry.get(buf.readIdentifier())) as CyberwareLayerPower
    init {
